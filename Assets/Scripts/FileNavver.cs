...
public class FileNavver : MonoBehaviour
{
    [Header("Input")]
    ...
    private void OnUp(InputAction.CallbackContext ctx)
    {
        ...
        switch (Layout)
        {
            case FileNavigationLayout.Grid:
                newIndex = currentIndex - columns;
                break;
            case FileNavigationLayout.TopToBottom:
                newIndex = currentIndex - 1;
                break;
            case FileNavigationLayout.BottomToTop:
                newIndex = currentIndex + 1;
                break;
        }
        ...
        switch (Layout)
        {
            case FileNavigationLayout.Grid:
                if ((currentIndex % columns) != 0)
                    newIndex = currentIndex - 1;
                break;
            case FileNavigationLayout.LeftToRight:
                if (currentIndex - 1 >= 0)
                    newIndex = currentIndex - 1;
                break;
        }
