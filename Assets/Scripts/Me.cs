...
public class Me : MonoBehaviour
{
    ...
    public List<SkinnedMeshRenderer> OutfitForWorkOne;
    ...
    public List<SkinnedMeshRenderer> OutfitForWorkOneTwo;
    ...
    public List<SkinnedMeshRenderer> OutfitForWorkOneThree;
    ...
    public List<SkinnedMeshRenderer> OutfitForWorkOneFour;
    ...
    public List<SkinnedMeshRenderer> OutfitForWorkSuitThree;
    ...
    public List<SkinnedMeshRenderer> OutfitForShortsAndTights;
    ...
    public List<SkinnedMeshRenderer> OutfitForNightie;
    ...
    public List<SkinnedMeshRenderer> OutfitForWoolenJumper;
    ...
    public List<SkinnedMeshRenderer> OutfitForDitzyDress;
    ...
    public List<SkinnedMeshRenderer> OutfitForLittleBlackDress;
    ...
    public List<SkinnedMeshRenderer> OutfitForNightOutOne;
    ...
    public List<SkinnedMeshRenderer> OutfitForLingerie;
    ...
    public List<SkinnedMeshRenderer> OutfitForFae;
    ...
    public void SetMainOutfit(OutfitType outfit)
    {
        ...
        switch (outfit)
        {
            case OutfitType.Work:             SetListEnabled(OutfitForWorkOne,               true); break;
            case OutfitType.WorkTwo:          SetListEnabled(OutfitForWorkOneTwo,            true); break;
            case OutfitType.WorkThree:        SetListEnabled(OutfitForWorkOneThree,          true); break;
            case OutfitType.WorkFour:         SetListEnabled(OutfitForWorkOneFour,           true); break;
            case OutfitType.WorkSuitThree:    SetListEnabled(OutfitForWorkSuitThree,         true); break;
            ...
            case OutfitType.Nightie:          SetListEnabled(OutfitForNightie,               true); break;
            case OutfitType.Date1:            SetListEnabled(OutfitForSecondDate,            true); break;
            case OutfitType.Date2:            SetListEnabled(OutfitForFirstDate,             true); break;
            ...
            case OutfitType.CuteSix:          SetListEnabled(OutfitForRuffleBlousseAndSkirt, true); break;
            ...
            case OutfitType.WoolenJumper:     SetListEnabled(OutfitForWoolenJumper,          true); break;
            case OutfitType.Edea:             SetListEnabled(OutfitForEdea,                  true); break;
            case OutfitType.DitzyDress:       SetListEnabled(OutfitForDitzyDress,            true); break;
            case OutfitType.LittleBlackDress: SetListEnabled(OutfitForLittleBlackDress,      true); break;
            case OutfitType.Casual3:          SetListEnabled(OutfitForNightOutOne,           true); break;
            ...
            case OutfitType.Lingerie:         SetListEnabled(OutfitForLingerie,        true); break;
            case OutfitType.ShortsAndTights:    SetListEnabled(OutfitForShortsAndTights,         true); break;
            case OutfitType.Fae:     SetListEnabled(OutfitForFae,          true); break;
        }
    ...
    {
        OutfitType[] pool = { OutfitType.Casual, OutfitType.Fitness };
        SwitchToOutfit(PickRandom(pool));
    }
    ...
    {
        OutfitType[] pool = { OutfitType.Lingerie, OutfitType.ShortsAndTights, OutfitType.Fae };
        SwitchToOutfit(PickRandom(pool));
    }
    ...
    {
        SetListEnabled(OutfitForWorkOne,               false);
        SetListEnabled(OutfitForWorkOneTwo,            false);
        SetListEnabled(OutfitForWorkOneThree,          false);
        SetListEnabled(OutfitForWorkOneFour,           false);
        SetListEnabled(OutfitForWorkSuitThree,         false);
        ...
        SetListEnabled(OutfitForNightie,               false);
        ...
        SetListEnabled(OutfitForWoolenJumper,          false);
        SetListEnabled(OutfitForEdea,                  false);
        SetListEnabled(OutfitForDitzyDress,            false);
        SetListEnabled(OutfitForLittleBlackDress,      false);
        SetListEnabled(OutfitForNightOutOne,           false);
        ...
        SetListEnabled(OutfitForLingerie,        false);
        SetListEnabled(OutfitForShortsAndTights,         false);
        SetListEnabled(OutfitForFae,          false);
