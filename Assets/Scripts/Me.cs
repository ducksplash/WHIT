    ...
    public void SetMainOutfit(OutfitType outfit)
    {
        ...
        switch (outfit)
        {
            ...
            case OutfitType.Date3:
                ...
                break;
            case OutfitType.CuteOne:
                InstantiatePrefabs(OutfitForCuteOne);
                break;
            case OutfitType.CuteTwo:
                InstantiatePrefabs(OutfitForCuteTwo);
                break;
            case OutfitType.CuteThree:
                InstantiatePrefabs(OutfitForCuteThree);
                break;
            case OutfitType.CuteFour:
                InstantiatePrefabs(OutfitForCuteFour);
                break;
            case OutfitType.CuteFive:
                InstantiatePrefabs(OutfitForCuteFive);
                break;
            case OutfitType.CuteSix:
                InstantiatePrefabs(OutfitForRuffleBlousseAndSkirt);
                break;
            case OutfitType.CuteSeven:
                InstantiatePrefabs(OutfitForCuteSeven);
                break;
            case OutfitType.CuteEight:
                InstantiatePrefabs(OutfitForCuteEight);
                break;
            ...
            case OutfitType.Casual3:
                InstantiatePrefabs(OutfitForNightOutOne);
                break;
            case OutfitType.Essie:
                InstantiatePrefabs(OutfitForEssie);
                break;
            case OutfitType.NightOutFour:
                InstantiatePrefabs(OutfitForNightOutFour);
                break;
