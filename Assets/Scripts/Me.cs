...
public class Me : MonoBehaviour
{
    ...
    [Header("Turtleneck & Pleated Skirt")]
    public bool TurtleneckAndPleatedSkirtOutfitEnabled = true;
    public List<GameObject> OutfitForTurtleneckAndPleatedSkirt;
    public Color lipsColorForTurtleneckAndPleatedSkirt = new Color(0.85f, 0.18f, 0.28f);
    public Color nailsColorForTurtleneckAndPleatedSkirt = new Color(0.88f, 0.68f, 0.73f);
    public bool JiggleTurtleneckAndPleatedSkirt;
    public bool WingsEnabledForTurtleneckAndPleatedSkirt;
    public bool ApronEnabledForTurtleneckAndPleatedSkirt;
    public bool HatEnabledForTurtleneckAndPleatedSkirt;
    public bool ChokerEnabledForTurtleneckAndPleatedSkirt;
    ...
    {
        if (SkinnedMeshRendererParentAccessories == null) 
        {
            Debug.LogWarning("SkinnedMeshRendererParentAccessories is not assigned on Me!");
            return;
        }
        ...
        foreach (var smr in SkinnedMeshRendererParentAccessories.GetComponentsInChildren<SkinnedMeshRenderer>(true))
        {
            ...
            // Do NOT enable/disable here — ApplyAccessories() will handle it
        }
    }
    ...
    private void InstantiatePrefabs(List<GameObject> prefabs)
    {
        ...
        if (Body == null)
        {
            Debug.LogError("Body SkinnedMeshRenderer is not assigned on Me!");
            return;
        }
    ...
    public bool IsOutfitEnabled(OutfitType outfit)
    {
        switch (outfit)
        {
            ...
            case OutfitType.TurtleneckAndPleatedSkirt:        return TurtleneckAndPleatedSkirtOutfitEnabled;
    ...
    // Reset all override flags — call this when you want a clean accessory state
    ...
    private void ApplyAccessories()
    {
        GetOutfitAccessoryDefaults(currentOutfit,
            out bool wingsDefault, out bool overallDefault,
            out bool hatDefault,   out bool chokerDefault);

        // Always explicitly set enabled state — never rely on previous frame state
    ...
    private void GetOutfitAccessoryDefaults(OutfitType outfit, out bool wings, out bool overall, out bool hat, out bool choker)
    {
        switch (outfit)
        {
            ...
            case OutfitType.TurtleneckAndPleatedSkirt:        wings = WingsEnabledForTurtleneckAndPleatedSkirt;             overall = ApronEnabledForTurtleneckAndPleatedSkirt;             hat = HatEnabledForTurtleneckAndPleatedSkirt;             choker = ChokerEnabledForTurtleneckAndPleatedSkirt;             break;
    ...
    private void SwitchToOutfit(OutfitType outfit)
    {
        switch (outfit)
        {
            ...
            case OutfitType.TurtleneckAndPleatedSkirt:        ToggleTurtleneckAndPleatedSkirtOutfit(true);        break;
    ...
    public void ToggleTurtleneckAndPleatedSkirtOutfit(bool? forceOn = null)       { JiggleToggle(JiggleTurtleneckAndPleatedSkirt);             ToggleMainOutfit(OutfitType.TurtleneckAndPleatedSkirt,         forceOn); }
    ...
    {
        HideAllAccessories(); // Safe to call — only affects shared accessories
        ClearOutfitMeshes();
        ...
        // Instantiate new outfit
        switch (outfit)
        {
            case OutfitType.Work:
                InstantiatePrefabs(OutfitForWorkOne);
                break;
            case OutfitType.WorkTwo:
                InstantiatePrefabs(OutfitForWorkOneTwo);
                break;
            case OutfitType.WorkThree:
                InstantiatePrefabs(OutfitForWorkOneThree);
                break;
            case OutfitType.WorkFour:
                InstantiatePrefabs(OutfitForWorkOneFour);
                break;
            case OutfitType.WorkSuitThree:
                InstantiatePrefabs(OutfitForWorkSuitThree);
                break;
            case OutfitType.Casual:
                InstantiatePrefabs(OutfitForCasual);
                break;
            case OutfitType.ShortsAndTights:
                InstantiatePrefabs(OutfitForShortsAndTights);
                break;
            case OutfitType.Fitness:
                InstantiatePrefabs(OutfitForFitness);
                break;
            case OutfitType.Pyjamas:
                InstantiatePrefabs(OutfitForPyjamas);
                break;
            case OutfitType.Housecoat:
                InstantiatePrefabs(OutfitForHousecoat);
                break;
            case OutfitType.Nightie:
                InstantiatePrefabs(OutfitForNightie);
                break;
            case OutfitType.Date1:
                InstantiatePrefabs(OutfitForSecondDate);
                break;
            case OutfitType.Date2:
                InstantiatePrefabs(OutfitForFirstDate);
                break;
            case OutfitType.Date3:
                InstantiatePrefabs(OutfitForThirdDate);
                break;
            case OutfitType.GreyCheckHalterDress:
                InstantiatePrefabs(OutfitForGreyCheckHalterDress);
                break;
            case OutfitType.SweaterAndSkirt:
                InstantiatePrefabs(OutfitForSweaterAndSkirt);
                break;
            case OutfitType.TurtleneckAndSkirt:
                InstantiatePrefabs(OutfitForTurtleneckAndSkirt);
                break;
            case OutfitType.CheckTopAndJeans:
                InstantiatePrefabs(OutfitForCheckTopAndJeans);
                break;
            case OutfitType.KnottedBlousseAndSkirt:
                InstantiatePrefabs(OutfitForKnottedBlousseAndSkirt);
                break;
            case OutfitType.RuffleBlousseAndSkirt:
                InstantiatePrefabs(OutfitForRuffleBlousseAndSkirt);
                break;
            case OutfitType.LooseTopAndLongSkirt:
                InstantiatePrefabs(OutfitForLooseTopAndLongSkirt);
                break;
            case OutfitType.TurtleneckAndPleatedSkirt:
                InstantiatePrefabs(OutfitForTurtleneckAndPleatedSkirt);
                break;
            case OutfitType.WoolenJumper:
                InstantiatePrefabs(OutfitForWoolenJumper);
                break;
            case OutfitType.Edea:
                InstantiatePrefabs(OutfitForEdea);
                break;
            case OutfitType.DitzyDress:
                InstantiatePrefabs(OutfitForDitzyDress);
                break;
            case OutfitType.LittleBlackDress:
                InstantiatePrefabs(OutfitForLittleBlackDress);
                break;
            case OutfitType.Casual3:
                InstantiatePrefabs(OutfitForFrootDress);
                break;
            case OutfitType.StraplessRuffleDress:
                InstantiatePrefabs(OutfitForStraplessRuffleDress);
                break;
            case OutfitType.CheckBodySuit:
                InstantiatePrefabs(OutfitForCheckBodySuit);
                break;
            case OutfitType.ElegantDress:
                InstantiatePrefabs(OutfitForElegantDress);
                break;
            case OutfitType.NightOutRuffle:
                InstantiatePrefabs(OutfitForNightOutRuffle);
                break;
            case OutfitType.Wedding:
                InstantiatePrefabs(OutfitForWedding);
                break;
            case OutfitType.Funeral:
                InstantiatePrefabs(OutfitForFuneral);
                break;
            case OutfitType.Homelessness:
                InstantiatePrefabs(OutfitForHomelessness);
                break;
            case OutfitType.Undergarments:
                InstantiatePrefabs(OutfitForUndergarments);
                break;
            case OutfitType.Lingerie:
                InstantiatePrefabs(OutfitForLingerie);
                break;
            case OutfitType.Fae:
                InstantiatePrefabs(OutfitForFae);
                break;
        }

        ApplyBodyColors(outfit);
        ApplyAccessories(); // This now controls the shared accessories reliably
    }
    ...
    public void DisableAllMainOutfits()
    {
        ...
        ApplyAccessories();   // Allow accessories even when naked
    }
    ...
    public void SetRandomCuteOutfit()
    {
        OutfitType[] pool =
        {
            ...
            OutfitType.KnottedBlousseAndSkirt,   OutfitType.RuffleBlousseAndSkirt,      OutfitType.LooseTopAndLongSkirt,     OutfitType.TurtleneckAndPleatedSkirt,
    ...
    public void SetRandomNightOutOutfit()
    {
        OutfitType[] pool =
        {
            OutfitType.Casual3, OutfitType.StraplessRuffleDress, OutfitType.CheckBodySuit,
    ...
    private Color GetLipColorForOutfit(OutfitType outfit)
    {
        switch (outfit)
        {
            ...
            case OutfitType.TurtleneckAndPleatedSkirt:        return lipsColorForTurtleneckAndPleatedSkirt;
    ...
    private Color GetNailColorForOutfit(OutfitType outfit)
    {
        switch (outfit)
        {
            ...
            case OutfitType.TurtleneckAndPleatedSkirt:        return nailsColorForTurtleneckAndPleatedSkirt;
...
public class MeTwoEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        if (GUILayout.Button("Turtleneck & Pleated Skirt", GUILayout.Height(35))) { me.ToggleTurtleneckAndPleatedSkirtOutfit(); EditorUtility.SetDirty(me); }
        EditorGUILayout.EndHorizontal();
        EditorGUILayout.BeginHorizontal();
