...
public class PhotoNavver : MonoBehaviour
{
    [Header("Input")]
    ...
    public List<PhotoButton> GridButtons = new List<PhotoButton>();

    [Header("Navigation Layout")]
    public PhotoPlayerNavigationLayout Layout = PhotoPlayerNavigationLayout.Grid;
    ...
    private void OnUp(InputAction.CallbackContext ctx)
    {
        ...
        switch (Layout)
        {
            case PhotoPlayerNavigationLayout.Grid:
                newIndex = currentIndex - columns;
                break;
            case PhotoPlayerNavigationLayout.TopToBottom:
                newIndex = currentIndex - 1;
                break;
            case PhotoPlayerNavigationLayout.BottomToTop:
                newIndex = currentIndex + 1;
                break;
        }
        ...
        switch (Layout)
        {
            case PhotoPlayerNavigationLayout.Grid:
                if ((currentIndex % columns) != 0)
                    newIndex = currentIndex - 1;
                break;
            case PhotoPlayerNavigationLayout.LeftToRight:
                if (currentIndex - 1 >= 0)
                    newIndex = currentIndex - 1;
                break;
        }
...
public enum PhotoPlayerNavigationLayout
{
    Grid,
    TopToBottom,
    BottomToTop,
