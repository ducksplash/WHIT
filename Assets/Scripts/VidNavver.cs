...
public class VidNavver : MonoBehaviour
{
    [Header("Input")]
    ...
    public List<VideoButton> GridButtons = new List<VideoButton>();

    [Header("Navigation Layout")]
    public VidNavigationLayout Layout = VidNavigationLayout.Grid;
    ...
    private void OnUp(InputAction.CallbackContext ctx)
    {
        ...
        switch (Layout)
        {
            case VidNavigationLayout.Grid:
                newIndex = currentIndex - columns;
                break;
            case VidNavigationLayout.TopToBottom:
                newIndex = currentIndex - 1;
                break;
            case VidNavigationLayout.BottomToTop:
                newIndex = currentIndex + 1;
                break;
        }
        ...
        switch (Layout)
        {
            case VidNavigationLayout.Grid:
                if ((currentIndex % columns) != 0)
                    newIndex = currentIndex - 1;
                break;
            case VidNavigationLayout.LeftToRight:
                if (currentIndex - 1 >= 0)
                    newIndex = currentIndex - 1;
                break;
        }
...
public enum VidNavigationLayout
{
    Grid,
    TopToBottom,
    BottomToTop,
