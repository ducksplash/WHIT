...
public class VidPlayerNavver : MonoBehaviour
{
    [Header("Input")]
    ...
    public List<VidControlButton> GridButtons = new List<VidControlButton>();

    [Header("Navigation Layout")]
    public VidPlayerNavigationLayout Layout = VidPlayerNavigationLayout.Grid;
    ...
    private void OnUp(InputAction.CallbackContext ctx)
    {
        ...
        switch (Layout)
        {
            case VidPlayerNavigationLayout.Grid:
                newIndex = currentIndex - columns;
                break;
            case VidPlayerNavigationLayout.TopToBottom:
                newIndex = currentIndex - 1;
                break;
            case VidPlayerNavigationLayout.BottomToTop:
                newIndex = currentIndex + 1;
                break;
        }
        ...
        switch (Layout)
        {
            case VidPlayerNavigationLayout.Grid:
                if ((currentIndex % columns) != 0)
                    newIndex = currentIndex - 1;
                break;
            case VidPlayerNavigationLayout.LeftToRight:
                if (currentIndex - 1 >= 0)
                    newIndex = currentIndex - 1;
                break;
        }
...
public enum VidPlayerNavigationLayout
{
    Grid,
    TopToBottom,
    BottomToTop,
