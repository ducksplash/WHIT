    ...
    public IEnumerator FillUp()
    {
        ...
        while (fillLevel < 100)
        {
            ...
            if (fillLevel > 25 && fillLevel < 50)
            {
                ...
                FillMilestone0.color = new Color(0, 0.5f, 0, 1);
            ...
            if (fillLevel > 50 && fillLevel < 75)
            {
                ...
                fillFG.color = new Color(1, 1, 0, 1);


                FillMilestone1.color = new Color(0, 0.5f, 0, 1);
            ...
            if (fillLevel > 75 && fillLevel < 100)
            {
                ...
                fillFG.color = Color.green;

                FillMilestone2.color = new Color(0, 0.5f, 0, 1);
            ...
            if (fillLevel >= 100)
            {
                ...
                FillMilestone3.color = new Color(0, 0.5f, 0, 1);
